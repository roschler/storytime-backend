...
exports.sessionGetAll = sessionGetAll;
 ...
 * Retrieve sessions
 */
async function sessionGetAll(client$, options) {
    var _a;
    const path$ = (0, url_js_1.pathToFunc)("/session")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetSessionsResponse$inboundSchema, { key: "data" }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetSessionsResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=sessionGetAll.js.map