 ...
 * Patch an asset
 */
async function assetUpdate(client$, assetId, assetPatchPayload, options) {
    var _a;
    const input$ = {
        assetId: assetId,
        assetPatchPayload: assetPatchPayload,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.UpdateAssetRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    const payload$ = parsed$.value;
    const body$ = (0, encodings_js_1.encodeJSON)("body", payload$["asset-patch-payload"], {
        explode: true,
    });
    const pathParams$ = {
    ...
    const [result$] = await m$.match(m$.json(200, operations.UpdateAssetResponse$inboundSchema, {
        key: "asset",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.UpdateAssetResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=assetUpdate.js.map