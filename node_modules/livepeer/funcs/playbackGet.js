...
exports.playbackGet = playbackGet;
 ...
 */
async function playbackGet(client$, id, options) {
    var _a;
    const input$ = {
        id: id,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.GetPlaybackInfoRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const path$ = (0, url_js_1.pathToFunc)("/playback/{id}")(pathParams$);
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetPlaybackInfoResponse$inboundSchema, {
        key: "playback-info",
    }), m$.jsonErr(404, errors.ErrorT$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetPlaybackInfoResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=playbackGet.js.map