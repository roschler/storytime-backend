...
exports.accessControlGetAll = accessControlGetAll;
 ...
 */
async function accessControlGetAll(client$, options) {
    var _a;
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetSigningKeysResponse$inboundSchema, {
        key: "data",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetSigningKeysResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=accessControlGetAll.js.map