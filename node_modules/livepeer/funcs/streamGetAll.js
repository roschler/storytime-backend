...
exports.streamGetAll = streamGetAll;
 ...
 * Retrieve streams
 */
async function streamGetAll(client$, streamsonly, options) {
    var _a;
    const input$ = {
        streamsonly: streamsonly,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.GetStreamsRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    const payload$ = parsed$.value;
    const body$ = null;
    const path$ = (0, url_js_1.pathToFunc)("/stream")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetStreamsResponse$inboundSchema, { key: "data" }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetStreamsResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=streamGetAll.js.map