...
exports.webhookResendLog = webhookResendLog;
 ...
 */
async function webhookResendLog(client$, id, logId, options) {
    var _a;
    const input$ = {
        id: id,
        logId: logId,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.ResendWebhookRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const pathParams$ = {
        ...
        logId: (0, encodings_js_1.encodeSimple)("logId", payload$.logId, {
            explode: false,
            charEncoding: "percent",
        }),
    };
    const path$ = (0, url_js_1.pathToFunc)("/webhook/{id}/log/{logId}/resend")(pathParams$);
    ...
    const [result$] = await m$.match(m$.json(200, operations.ResendWebhookResponse$inboundSchema, {
        key: "webhook-log",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.ResendWebhookResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=webhookResendLog.js.map