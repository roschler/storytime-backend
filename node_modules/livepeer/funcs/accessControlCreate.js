...
exports.accessControlCreate = accessControlCreate;
 ...
 */
async function accessControlCreate(client$, options) {
    var _a;
    const path$ = (0, url_js_1.pathToFunc)("/access-control/signing-key")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.CreateSigningKeyResponse$inboundSchema, {
        key: "signing-key",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.CreateSigningKeyResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=accessControlCreate.js.map