...
exports.roomDeleteUser = roomDeleteUser;
 ...
 */
async function roomDeleteUser(client$, id, userId, options) {
    var _a;
    const input$ = {
        id: id,
        userId: userId,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.DeleteRoomUserRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const [result$] = await m$.match(m$.nil(204, operations.DeleteRoomUserResponse$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.DeleteRoomUserResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=roomDeleteUser.js.map