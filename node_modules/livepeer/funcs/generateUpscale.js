...
exports.generateUpscale = generateUpscale;
 ...
 */
async function generateUpscale(client$, request, options) {
    var _a;
    const input$ = request;
    const parsed$ = schemas$.safeParse(input$, (value$) => components.BodyGenUpscale$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const path$ = (0, url_js_1.pathToFunc)("/api/beta/generate/upscale")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.GenUpscaleResponse$inboundSchema, {
        key: "ImageResponse",
    }), m$.jsonErr(400, errors.GenUpscaleResponseBody$inboundSchema), m$.jsonErr(401, errors.GenUpscaleGenerateResponseBody$inboundSchema), m$.jsonErr(422, errors.GenUpscaleGenerateResponseResponseBody$inboundSchema), m$.jsonErr(500, errors.GenUpscaleGenerateResponse500ResponseBody$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GenUpscaleResponse$inboundSchema, {
...
//# sourceMappingURL=generateUpscale.js.map