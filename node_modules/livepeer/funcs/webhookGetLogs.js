...
exports.webhookGetLogs = webhookGetLogs;
 ...
 */
async function webhookGetLogs(client$, id, options) {
    var _a;
    const input$ = {
        id: id,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.GetWebhookLogsRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const path$ = (0, url_js_1.pathToFunc)("/webhook/{id}/log")(pathParams$);
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetWebhookLogsResponse$inboundSchema, {
        key: "data",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetWebhookLogsResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=webhookGetLogs.js.map