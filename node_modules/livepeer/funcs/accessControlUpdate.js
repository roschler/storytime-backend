 ...
 */
async function accessControlUpdate(client$, keyId, requestBody, options) {
    var _a;
    const input$ = {
        keyId: keyId,
        requestBody: requestBody,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.UpdateSigningKeyRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const [result$] = await m$.match(m$.nil(204, operations.UpdateSigningKeyResponse$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.UpdateSigningKeyResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=accessControlUpdate.js.map