 ...
 */
async function webhookCreate(client$, request, options) {
    var _a;
    const input$ = request;
    const parsed$ = schemas$.safeParse(input$, (value$) => components.WebhookInput$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    const payload$ = parsed$.value;
    const body$ = (0, encodings_js_1.encodeJSON)("body", payload$, { explode: true });
    const path$ = (0, url_js_1.pathToFunc)("/webhook")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.CreateWebhookResponse$inboundSchema, {
        key: "webhook",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.CreateWebhookResponse$inboundSchema, {
        key: "error",
