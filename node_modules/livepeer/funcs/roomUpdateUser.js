...
exports.roomUpdateUser = roomUpdateUser;
 ...
 */
async function roomUpdateUser(client$, id, userId, roomUserUpdatePayload, options) {
    var _a;
    const input$ = {
        id: id,
        userId: userId,
    ...
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.UpdateRoomUserRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    const payload$ = parsed$.value;
    const body$ = (0, encodings_js_1.encodeJSON)("body", payload$["room-user-update-payload"], {
        explode: true,
    });
    const pathParams$ = {
    ...
    const path$ = (0, url_js_1.pathToFunc)("/room/{id}/user/{userId}")(pathParams$);
    ...
    const [result$] = await m$.match(m$.nil(204, operations.UpdateRoomUserResponse$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.UpdateRoomUserResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=roomUpdateUser.js.map