...
exports.streamGetClips = streamGetClips;
 ...
 */
async function streamGetClips(client$, id, options) {
    var _a;
    const input$ = {
        id: id,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.GetClipsRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const path$ = (0, url_js_1.pathToFunc)("/stream/{id}/clips")(pathParams$);
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetClipsResponse$inboundSchema, { key: "data" }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetClipsResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=streamGetClips.js.map