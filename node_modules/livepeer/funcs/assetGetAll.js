...
exports.assetGetAll = assetGetAll;
 ...
 * Retrieve assets
 */
async function assetGetAll(client$, options) {
    var _a;
    const path$ = (0, url_js_1.pathToFunc)("/asset")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetAssetsResponse$inboundSchema, { key: "data" }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetAssetsResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=assetGetAll.js.map