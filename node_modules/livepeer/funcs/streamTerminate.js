...
exports.streamTerminate = streamTerminate;
 ...
 * terminated.
 */
async function streamTerminate(client$, id, options) {
    var _a;
    const input$ = {
        id: id,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.TerminateStreamRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const path$ = (0, url_js_1.pathToFunc)("/stream/{id}/terminate")(pathParams$);
    ...
    const [result$] = await m$.match(m$.nil(204, operations.TerminateStreamResponse$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.TerminateStreamResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=streamTerminate.js.map