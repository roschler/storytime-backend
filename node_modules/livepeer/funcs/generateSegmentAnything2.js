...
exports.generateSegmentAnything2 = generateSegmentAnything2;
 ...
 */
async function generateSegmentAnything2(client$, request, options) {
    var _a;
    const input$ = request;
    const parsed$ = schemas$.safeParse(input$, (value$) => components.BodyGenSegmentAnything2$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const path$ = (0, url_js_1.pathToFunc)("/api/beta/generate/segment-anything-2")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.GenSegmentAnything2Response$inboundSchema, {
        key: "MasksResponse",
    }), m$.jsonErr(400, errors.GenSegmentAnything2ResponseBody$inboundSchema), m$.jsonErr(401, errors.GenSegmentAnything2GenerateResponseBody$inboundSchema), m$.jsonErr(422, errors.GenSegmentAnything2GenerateResponseResponseBody$inboundSchema), m$.jsonErr(500, errors.GenSegmentAnything2GenerateResponse500ResponseBody$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GenSegmentAnything2Response$inboundSchema, {
...
//# sourceMappingURL=generateSegmentAnything2.js.map