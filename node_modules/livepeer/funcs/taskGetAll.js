 ...
 * Retrieve Tasks
 */
async function taskGetAll(client$, options) {
    var _a;
    const path$ = (0, url_js_1.pathToFunc)("/task")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetTasksResponse$inboundSchema, { key: "data" }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetTasksResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=taskGetAll.js.map