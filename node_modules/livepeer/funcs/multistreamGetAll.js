...
exports.multistreamGetAll = multistreamGetAll;
 ...
 */
async function multistreamGetAll(client$, options) {
    var _a;
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetMultistreamTargetsResponse$inboundSchema, {
        key: "data",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetMultistreamTargetsResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=multistreamGetAll.js.map