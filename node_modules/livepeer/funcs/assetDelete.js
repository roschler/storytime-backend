 ...
 * Delete an asset
 */
async function assetDelete(client$, assetId, options) {
    var _a;
    const input$ = {
        assetId: assetId,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.DeleteAssetRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const [result$] = await m$.match(m$.nil(204, operations.DeleteAssetResponse$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.DeleteAssetResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=assetDelete.js.map