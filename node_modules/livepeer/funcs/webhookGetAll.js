...
exports.webhookGetAll = webhookGetAll;
 ...
 * Retrieve a Webhook
 */
async function webhookGetAll(client$, options) {
    var _a;
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetWebhooksResponse$inboundSchema, { key: "data" }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetWebhooksResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=webhookGetAll.js.map