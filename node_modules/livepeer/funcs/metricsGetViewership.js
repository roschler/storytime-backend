...
exports.metricsGetViewership = metricsGetViewership;
 ...
 */
async function metricsGetViewership(client$, request, options) {
    var _a;
    const input$ = request;
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.GetViewershipMetricsRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    const payload$ = parsed$.value;
    const body$ = null;
    const path$ = (0, url_js_1.pathToFunc)("/data/views/query")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetViewershipMetricsResponse$inboundSchema, {
        key: "data",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetViewershipMetricsResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=metricsGetViewership.js.map