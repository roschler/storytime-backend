 ...
 */
async function roomDelete(client$, id, options) {
    var _a;
    const input$ = {
        id: id,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.DeleteRoomRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const path$ = (0, url_js_1.pathToFunc)("/room/{id}")(pathParams$);
    ...
    const [result$] = await m$.match(m$.nil(204, operations.DeleteRoomResponse$inboundSchema), m$.fail(["4XX", "5XX"]), m$.json("default", operations.DeleteRoomResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=roomDelete.js.map