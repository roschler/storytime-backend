...
exports.roomGetUser = roomGetUser;
 ...
 */
async function roomGetUser(client$, id, userId, options) {
    var _a;
    const input$ = {
        id: id,
        userId: userId,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.GetRoomUserRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetRoomUserResponse$inboundSchema, {
        key: "get-room-user-response",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetRoomUserResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=roomGetUser.js.map