...
exports.sessionGetClips = sessionGetClips;
 ...
 */
async function sessionGetClips(client$, id, options) {
    var _a;
    const input$ = {
        id: id,
    };
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.GetSessionClipsRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    ...
    const path$ = (0, url_js_1.pathToFunc)("/session/{id}/clips")(pathParams$);
    ...
    const [result$] = await m$.match(m$.json(200, operations.GetSessionClipsResponse$inboundSchema, {
        key: "data",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.GetSessionClipsResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=sessionGetClips.js.map