...
exports.streamCreateClip = streamCreateClip;
 ...
 * Create a clip
 */
async function streamCreateClip(client$, request, options) {
    var _a;
    const input$ = request;
    const parsed$ = schemas$.safeParse(input$, (value$) => components.ClipPayload$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
    const payload$ = parsed$.value;
    const body$ = (0, encodings_js_1.encodeJSON)("body", payload$, { explode: true });
    const path$ = (0, url_js_1.pathToFunc)("/clip")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.CreateClipResponse$inboundSchema, { key: "data" }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.CreateClipResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=streamCreateClip.js.map