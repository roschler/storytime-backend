 ...
 */
async function roomCreate(client$, options) {
    var _a;
    const path$ = (0, url_js_1.pathToFunc)("/room")();
    ...
    const [result$] = await m$.match(m$.json(200, operations.CreateRoomResponse$inboundSchema, {
        key: "create-room-response",
    }), m$.fail(["4XX", "5XX"]), m$.json("default", operations.CreateRoomResponse$inboundSchema, {
        key: "error",
