...
export declare class Transcode extends ClientSDK {
    /**
     * Transcode a video
     *
     * @remarks
     ...
     * ```
     */
    create(request: components.TranscodePayload, options?: RequestOptions): Promise<operations.TranscodeVideoResponse>;
}
